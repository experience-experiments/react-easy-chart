    ...
    value: function setScaleDomainRange(axesType, domainRange, data, type, length) {
      ...
      switch (type) {
        ...
        case 'linear':
          ...
          d3Axis.domain(domainRange ? this.calcDefaultDomain(domainRange, type) : [0, (0, _d.max)(data, function (d) {
            return d[dataIndex];
          })]);
        ...
        case 'time':
          ...
          d3Axis.domain(domainRange ? this.calcDefaultDomain(domainRange, type) : (0, _d3Array.extent)(data, function (d) {
