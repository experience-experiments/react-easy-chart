...
class LineChartContainer extends React.Component {
        ...
        <div className="content">
          ...
          <section id="introduction">
            ...
            <p>
              ...
              of data points called 'markers' connected by straight line segments.<sup>(<a href="https://en.wikipedia.org/wiki/Line_chart">ref</a>)</sup>
            </p>
          </section>
          ...
          <section id="data">
            ...
            <p>
              At the most basic the line chart can just take a single data file supplied in a JSON
              format and will render a simple line chart.
            </p>

            <p>
              The format of the data is an array of arrays which allows multiple lines to be
              generated. The x field represents the x axis and the y the y axis. This is to
              unify the data across R2-D3 charts.
            </p>
  ...
  />`);
            ...
            <p>
              If a second line is needed then this is easily added by adding a new data array to
              the existing array. The number of lines drawn is infinite but only coloured up to
              4 lines.
            </p>
  ...
  />`);
          ...
          <section id="axesAndLabels">
            ...
            <p>
              The axisLabels can be overridden by simply passing <b>axisLabels</b> object with both
              a x and y y.
            </p>
  ...
  />`);
          ...
          <section id="interpolate">
            ...
            <p>
              The Lines drawn can be set to be interpolated by passing in an interpolated param. By
              default this is set to linear. We can though override this for instance to make a
              cardinal line. The options that can be chosen can be found
              <a href="https://github.com/mbostock/d3/wiki/SVG-Shapes">here</a> under the interpolate section.
            </p>
  ...
  />`);
          ...
          <section id="xType">
            ...
            <p>
              ...
              format is for example 1-Jan-15 but can be overridden) or textual formats (used for
              labelling).
            </p>

            <p>
              For the example below the data for the x is text and so the <b>xType</b> needs to be
              changed to <b>text</b>.
            </p>
  ...
  />`);
            ...
            <p>
              Setting the <b>xType</b> to be <b>time</b>.
            </p>
  ...
  />`);
            ...
            <p>
              Setting the <b>yType</b> to be <b>text</b>. (The yDomainRange has also been set to
              keep the range order.)
            </p>
  ...
  />`);
            ...
            <p>
              Setting the <b>yType</b> to be <b>time</b>
            </p>
  ...
  />`);
          ...
          <section id="lineColors">
            <h2>Line Colors</h2>
            <p>
              The colours of the lines can be overridden easily. To do this we can pass in a
              lineColors array as a prop.
            </p>
  ...
  />`);
            ...
            <div style={{ display: 'inline-block' }}>
              ...
              <LineChart
                xType={'time'}
                axes={(this.state.componentWidth) > 600}
                xTicks={5}
                yTicks={3}
                grid
                width={this.state.componentWidth}
