...
export default class PieChartContainer extends PureComponent {
        ...
        <div className="content">
          ...
          <section id="introduction">
            ...
            <p>
              ...
              into slices to illustrate numerical proportion.<sup>(<a href="https://en.wikipedia.org/wiki/Pie_chart">ref</a>)</sup>
            </p>
          </section>
          ...
          <section id="data">
            ...
            <p>
              At the most basic the Pie chart can just take a single data file supplied in a JSON
              format and will render a simple Pie chart. This is a single array of JavaScript
  ...
  />`);
            ...
            <p>
              ...
              section of the pie by providing an extra color hex value to the object.
            </p>
  ...
  />`);
          ...
          <section id="donut">
            ...
            <p>
              A donut can be produced by passing in a innerHoleSize prop. This should be less than
              the size prop.
            </p>
  ...
  />`);
          ...
          <section id="labels">
            ...
            <p>
              Labels can be added by passing in a labels boolean prop. The labels will be the key
              value passed in with the data. The example below passes a custom style object to set
  ...
  />`);
          ...
          <section id="style">
            ...
            <p>
              Styles for the lines and the text can be overridden by passing in a styles object
              prop.
            </p>
    ...
    />`);
          ...
          <section id="mouseHandlers">
            ...
            <p>
              ...
              provides the mouse event and the segment data. The mouse event can for instance
              provide the x and y coordinates which can be used for a tool tip. The data can be
              segment related to the pie chart.
            </p>
