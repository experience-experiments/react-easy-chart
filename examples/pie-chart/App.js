      ...
      return (
        <div>
          {(this.state.showToolTip)
            ? <ToolTip top={this.state.top} left={this.state.left}>The value of {this.state.key} is {this.state.value}</ToolTip>
            : null}
          ...
          <div className="content">
            ...
            <section id="data">
              <h2>data</h2>
              <p>At the most basic the Pie chart can just take a single data file supplied in a JSON format and will render a simple Pie chart. This is a single array of JavaScript objects with a key and value.</p>
              <pre>
              {(() => {
                const html = (`
  <PieChart
